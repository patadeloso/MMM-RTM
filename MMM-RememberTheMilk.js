...
Module.register("MMM-RememberTheMilk", {
...
//		self.initialLoaded = false;
		...
		Log.info("RememberTheMilk fetches every " + seconds + " seconds");
		window.setInterval(function() {
			self.sendSocketNotification("GET_TODAY", self.config);
		}, seconds);
	},
	...
	//	}
		if (notification === "TODAY") {
			Log.info("Got RememberTheMilk today data: " + this.name);
			tasks = payload;
			this.updateDom(3000);
		}
	},
